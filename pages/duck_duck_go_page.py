...
class DuckDuckGoPage:
    ...
    _SEARCH_RESULT = (By.XPATH, '(//android.view.View[@content-desc="Alireza SoltaniJazi - '
    ...
    def get_first_index_of_search_results(self) -> str:
        condition = expected_conditions.visibility_of_element_located(self._SEARCH_RESULT)
        search_input: WebElement = self._explicit_wait.until(condition)
